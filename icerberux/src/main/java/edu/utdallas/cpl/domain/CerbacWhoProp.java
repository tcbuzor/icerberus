 ...
 */
@Entity
@Table(name = "cerbac_who_prop")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class CerbacWhoProp implements Serializable {
    ...
    public CerbacWhoProp id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public CerbacWhoProp name(String name) {
        this.name = name;
        return this;
    }
    ...
    public CerbacWhoProp value(String value) {
        this.value = value;
        return this;
    }
    ...
    public CerbacWhoProp condition(ConditionEnum condition) {
    ...
    public CerbacWhoProp entityProperty(CerbacEntityProp cerbacEntityProp) {
    ...
    public CerbacWhoProp policyRule(CerbacPolicyRule cerbacPolicyRule) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CerbacWhoProp)) {
            return false;
        }
        return id != null && id.equals(((CerbacWhoProp) o).id);
    }
