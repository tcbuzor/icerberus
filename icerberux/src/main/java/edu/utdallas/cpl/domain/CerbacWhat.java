 ...
 */
@Entity
@Table(name = "cerbac_what")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class CerbacWhat implements Serializable {
    ...
    public CerbacWhat name(String name) {
        this.name = name;
        return this;
    }
    ...
    public CerbacWhat cerbacEntity(CerbacEntity cerbacEntity) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CerbacWhat)) {
            return false;
        }
        return id != null && id.equals(((CerbacWhat) o).id);
    }
