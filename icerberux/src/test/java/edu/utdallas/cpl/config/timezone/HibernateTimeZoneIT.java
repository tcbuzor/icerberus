package edu.utdallas.cpl.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import edu.utdallas.cpl.IntegrationTest;
import edu.utdallas.cpl.repository.timezone.DateTimeWrapper;
import edu.utdallas.cpl.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM cpl_date_time_wrapper where id=%d", fieldName, id);
    }
